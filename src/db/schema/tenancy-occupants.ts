...
export const tenancyOccupants = pgTable(
  "tenancy_occupants",
  {
  ...
  (table) => [index("tenancy_occupants_tenancy_id_idx").on(table.tenancyId), index("tenancy_occupants_person_id_idx").on(table.personId)],
);
