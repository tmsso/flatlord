// The four automatic/background notification events wired into the
// notification centre (ROADMAP Phase 3 item 4). amount-due is
// deliberately excluded — see migration 0022's comment.
export const NOTIFICATION_CATEGORIES = ["request", "notice", "inventory", "field_edit"] as const;
...
export const OWNER_NOTIFICATION_CATEGORIES: readonly NotificationCategory[] = ["request", "inventory", "field_edit"];
export const TENANT_NOTIFICATION_CATEGORIES: readonly NotificationCategory[] = ["request", "notice"];
